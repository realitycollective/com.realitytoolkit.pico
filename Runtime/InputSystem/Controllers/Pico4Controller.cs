...
namespace RealityToolkit.Pico.InputSystem.Controllers
{
    ...
    public class Pico4Controller : PicoController
    {
        ...
        /// <inheritdoc />
        public Pico4Controller(IMixedRealityControllerDataProvider controllerDataProvider, TrackingState trackingState, Handedness controllerHandedness, MixedRealityControllerMappingProfile controllerMappingProfile)
